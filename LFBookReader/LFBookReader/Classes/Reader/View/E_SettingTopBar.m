...
//    [multifunctionBtn setImage:[UIImage imageNamed:@"reader_more.png"] forState:0];
    [multifunctionBtn setTitle:@"标签" forState:UIControlStateNormal];
    [multifunctionBtn setTitleColor:[UIColor whiteColor] forState:0];
    [multifunctionBtn.titleLabel setFont:[UIFont systemFontOfSize:16]];
    ...
    UILabel *lable = [[UILabel alloc] initWithFrame:CGRectMake((LFScreenW - 100)/2, 20, 100, 44)];
